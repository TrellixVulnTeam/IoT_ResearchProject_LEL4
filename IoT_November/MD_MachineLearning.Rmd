...
For the analysis of the kitchen coffee machine feature it was determined that the best parameters were 'gini' with a max tree depth of 2. However, looking at the plot of Mean CV Score versus Maximum depth, it is noted that the 'gini' and 'entropy' values are identical. While the shape of the ROC curve and the corresponding ROC_AUC value of 0.9599 are indicative of a good fit, overall the model would be considered to be overfit. To support this, the we observe recall and precision scores of 1.0. The overfitting of this model is attributed to the extreme weighting towards the value of 0, as opposed to 1. Overall, of the 1588 instances, 1587 of them are 0, while only 1 value is one. Thus the model has not successfully fit.
