...
\caption{\label{tab:TAB_ALL}A sample of n=1 of each sub-activity from the pre-processed dataset. The table has been coloured to indicate futher pre-processing steps, as discussed below.}
\centering
\resizebox{\linewidth}{!}{\fontsize{8}{10}\selectfont
