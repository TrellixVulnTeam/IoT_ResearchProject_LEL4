...
```{python FUNC_reqEnergy_containSpecialCharClean, include=FALSE}
...
```{python FUNC_dsS1Activities_processingExample, include=FALSE}
...
```{r TAB_processingExample, echo=FALSE, results='asis'}
head(py$df) %>% kable(format = "latex", caption = "Demo table", booktabs = T) %>% 
...
head(py$dsS1) %>% kable(format = "latex", caption = "Demo table", booktabs = T) %>% 
  kable_styling(latex_options = c("hold_position", "striped", "scale_down"),
                bootstrap_options = c("striped", "hover", "condensed"),
                font_size = 8)
```
...
```{python FUNC_dsS1Activities_processing, include=FALSE}
...
head(py$dsIntermediate) %>% kable(format = "latex", caption = "Demo table", booktabs = T) %>% 
  kable_styling(latex_options = c("hold_position", "striped"),
                bootstrap_options = c("striped", "hover", "condensed"),
                font_size = 8)
```
