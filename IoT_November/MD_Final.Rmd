...
In order to develop understanding of the interrelaterness of the sub-activites, the data from the sequential analysis `ds_1n_60s.csv` were plotted as Sankey diagrams using a bespoke wrapper method written in Python. Using the previously mentioned temporal features of `HOUR` and ``

In addition to the previously mentioned temporal features 
